...
* Manutenção e evolução dos runners self-hosted do GitHub Actions na AWS, garantindo disponibilidade contínua dos pipelines CI/CD
...
* Manutenção e evolução do IAM Identity Center e Keycloak em Kubernetes para autenticação centralizada e governança de acesso
...
* Otimização e evolução da infraestrutura ECS, incluindo melhorias de containerização Docker e design cloud-native
...
* Projeto e implementação de runners self-hosted do GitHub Actions na AWS, reduzindo tempo de execução de pipelines CI/CD de horas para aproximadamente 15 minutos
...
* Participação na modernização de infraestrutura migrando workloads de AWS Elastic Beanstalk para ECS, incluindo containerização Docker e design de infraestrutura cloud-native
