...
Este guia mostra o **workflow completo de investigação**, combinando Git e GitHub CLI para rastrear bugs desde a linha problemática até o PR responsável.
...
💡 Esse workflow permite identificar rapidamente a origem de bugs em aplicações Rails e entender o contexto completo da mudança.

---

## Índice

- [Workflow Completo: Da Linha ao PR](#workflow-completo-da-linha-ao-pr)
...
Vamos seguir um **caso real** em uma aplicação Rails. Imagine que você encontrou um bug nesta linha do modelo User:
